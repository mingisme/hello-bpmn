...
//        cfg.setJdbcDriver("org.h2.Driver");
        cfg.setJdbcUrl("jdbc:mysql://localhost:3306/flow660?useUnicode=true&characterEncoding=utf8&autoReconnect=true&rewriteBatchedStatements=TRUE");
        cfg.setJdbcUsername("root");
        cfg.setJdbcPassword("123456");
        cfg.setJdbcDriver("com.mysql.cj.jdbc.Driver");
        cfg.setDatabaseSchemaUpdate(null);
